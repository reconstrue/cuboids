...
out component integration, both technically and with compatable
licences i.e. commercially friendly. For example, a system which uses
[[https://bossdb.org/][bossDB]] with [[https://github.com/seung-lab/chunkflow][chunkflow]] to reconstruct nuerons from brightfield
