...
- ~cuboids~: the proposed modified codebase

Additionally, there seems to be a trend in JHU/APL's documentation to
casually refer to the codebase as "the Boss" so the Boss and bossDB
refer to the same thing, that is the originally architected codebase.
